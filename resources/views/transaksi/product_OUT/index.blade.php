...
<section class="section">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('transaksi_OUT.store') }}" method="post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        <label for="nomorOUT"><strong>Nomor transaksi OUT</strong></label>
                       <input type="text" value ="{{'NTO'.date("Y"). $kd }}" class="form-control" id="nomorOUT" name="nomorOUT" readonly required>
                    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="the-icon">
                            ...
                            <div class="mx-3">
                                <form action="{{ route('transaksi_OUT.destroy',$row->id) }}" method="post">
                                    @method("DELETE")
                                    @csrf
